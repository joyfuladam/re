...
1. **Publishing Rights:** You assign 100% of the publisher's share of royalties to River & Ember. You keep 100% of the writer's share, which your PRO (ASCAP, BMI, SESAC) pays directly to you.

2. **Scope:** This only applies to the specific songs listed in Exhibit A. You keep full publishing rights to all your other songs.

3. **Master Rights:** This agreement does NOT cover master recording rights. If you're also a performer on the recording, those rights are handled in a separate Master Revenue Share Agreement.

4. **Term & Reversion:** This agreement lasts indefinitely, but you can get your rights back if: (a) at least 10 years have passed since the song's first release, (b) the publisher's share earned less than $500 over the prior 24 months, and (c) River & Ember can't fix that within 6 months of your written notice.

5. **Warranties:** You confirm the songs are original, don't infringe on anyone else's rights, and you have the authority to sign this agreement.

6. **Governing Law:** Any legal disputes are handled under the laws of the state specified in this agreement.

7. **Derivative Works:** River & Ember can create alternative versions of the songs (remixes, acoustic versions, translations, etc.) for their projects. You still get songwriting credit and keep your writer's share on those versions.

8. **Indemnification:** If either side causes a legal problem (like a copyright claim), the responsible party covers the other's costs and legal fees.

9. **Entire Agreement:** This document is the complete agreement. Any changes must be in writing and signed by both parties.

10. **Assignment:** River & Ember can transfer this agreement to another entity (like in a sale or merger). You cannot transfer your obligations without River & Ember's written permission.
...
1. **Services & Rights:** You provide your services for this recording, and River & Ember owns the master recording. Your contribution is considered work-made-for-hire.

2. **Compensation:** You receive {{collaborator_share_percentage}}% of Net Receipts from digital revenue (streaming and downloads only). You do NOT receive revenue from sync licenses, physical sales, live performances, or other uses.

3. **Alternative Versions:** River & Ember can create remixes, acoustic versions, and other alternative versions of the recording. You have no right to compensation from those unless separately agreed in writing.

4. **Publishing:** This agreement does NOT cover publishing rights. If you're also a songwriter, those are handled in a separate Publishing Assignment Agreement.

5. **Warranties:** You confirm your contribution is original, doesn't infringe on anyone else's rights, and you have the authority to sign this agreement.

6. **Governing Law:** Any legal disputes are handled under the laws of the state specified in this agreement.

7. **Entire Agreement:** This document is the complete agreement. Any changes must be in writing and signed by both parties.
